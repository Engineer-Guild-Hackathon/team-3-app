...
| --- | --- | --- | --- | --- | --- |
| UC-001 | 生徒AIとの会話 | 学習者 | 生徒AIがトピックについて質問してくるので，それに回答する．この過程で自分の知識の穴を発見する．常にわからないボタンを表示し，これを押した場合，会話を終了し，一定期間後に再質問する．会話終了後に自己評価ボタンを表示する． | ログイン済 | 会話トピックについて，回答・自己評価から理解度を求めて，タグとして付与． |
