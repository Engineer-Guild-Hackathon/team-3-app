          ...
          <AnimatePresence mode="wait">
            {isExpanded ? (
              ...
              <motion.div
                ...
                className="flex-1 flex flex-col justify-start space-y-2 overflow-y-auto scrollbar-hide"
              >
        ...
        {onNavigateToProfile && (
          <div className="p-4 flex-shrink-0">
            <motion.button
              ...
              className="
                w-full rounded-2xl
                backdrop-blur-xl bg-gray-500/10 border border-white/20
                hover:bg-gray-500/20 transition-colors duration-200
